...
void print_stat(long int duration, unsigned long long int max_seq, double data_bits, int data_pkts, bool isRcv, double avg_delay, double min_delay, double max_delay, int re_pkts)
{
